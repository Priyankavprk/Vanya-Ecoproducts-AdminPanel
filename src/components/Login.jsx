    ...
    return (
        <div className='min-h-screen flex items-center justify-center w-full'>
            <div className='bg-white shadow-md rounded-lg px-8 py-6 max-w-md'>
                <h1 className='text-2xl font-bold mb-4  text-green-800'>Admin Panel</h1>
                <form onSubmit={onSubmitHandler}>
                    ...
                    <button type='submit' className='mt-2 w-full py-2 px-4 rounded-md text-white bg-green-800'>Login</button>
                </form>
            </div>
        </div>
    )
